 ...
 * @version 1.0
 * 
 * @brief Gestore dell'input
 * Questa classe gestisce a chi inoltrare e a chi no il dato ricevuto in input
 */
public class InputManager {
    ...
    /** @brief Costruttore
     * Inizializza la mappa di sottoscrizioni
     */
    public InputManager() {
        subscriptions = new HashMap<>();
    }

    /** @brief Sottoscrizione
     *  Con questo metodo, si aggiunge l'oggetto obj nella lista delle sottoscrizioni
    ...
    /**@brief Cancella l'iscrizione
     * Con questo metodo, l'elemento obj viene rimosso dalla lista delle classi sottoscritte
    ...
    /** @brief Inoltro nuovo valore
     * Segnala ed inoltra a tutte gli elementi nella lista il nuovo valore in input
