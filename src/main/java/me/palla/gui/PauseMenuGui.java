...
public class PauseMenuGui extends PauseGui {
    ...
    public PauseMenuGui() {
        addComponent(new PauseMenuButton("Resume", NORMAL_COLOR, FOCUSED_COLOR, BUTTON_SIZE,
                () -> game.displayGui(new GameGui())));
        addComponent(new PauseMenuButton("Options", NORMAL_COLOR, FOCUSED_COLOR, BUTTON_SIZE,
                () -> game.displayGui(new OptionsGui())));
        addComponent(new PauseMenuButton("Exit", NORMAL_COLOR, FOCUSED_COLOR, BUTTON_SIZE,
                () -> game.shutdown()));
    }
